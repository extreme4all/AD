...
$startFolder = "C:\Users\ycreyf\Desktop\Test\LVL_1 - Copy (4) - Copy\"# must have slash at the end
$start = "C:\Users\ycreyf\Desktop\Test\" # must have slash at the end
